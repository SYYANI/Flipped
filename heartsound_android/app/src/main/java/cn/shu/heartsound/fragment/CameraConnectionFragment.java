...
import cn.shu.heartsound.customview.AutoFitTextureView;
...
public class CameraConnectionFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    textureView = (AutoFitTextureView) inflater.inflate(layout,container).findViewById(R.id.texture);
...
//                    CaptureRequest.CONTROL_AE_MODE, CaptureRequest.CONTROL_AE_MODE_ON_AUTO_FLASH);
                ...
                // Using https://stackoverflow.com/questions/35439159/camera2-api-set-custom-white-balance-temperature-color
                // to set custom white balance color, since it's green otherwise
                ...
                previewRequestBuilder.set(CaptureRequest.COLOR_CORRECTION_GAINS, CameraConnectionFragment.colorTemperature(5000));

                previewRequestBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, 20000000L);
