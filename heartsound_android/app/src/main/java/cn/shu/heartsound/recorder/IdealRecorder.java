package cn.shu.heartsound.recorder;
...
import cn.shu.heartsound.recorder.file.AudioFileHelper;
import cn.shu.heartsound.recorder.file.AudioFileListener;
import cn.shu.heartsound.recorder.record.Recorder;
import cn.shu.heartsound.recorder.record.RecorderCallback;
import cn.shu.heartsound.recorder.utils.BytesTransUtil;
...
public class IdealRecorder implements RecorderCallback, AudioFileListener {
    ...
    private cn.shu.heartsound.recorder.StatusListener statusListener;
     ...
     * @return
     */
    public IdealRecorder setStatusListener(cn.shu.heartsound.recorder.StatusListener statusListener) {
    ...
    public boolean onRecorderReady() {
        if (!isRecordAudioPermissionGranted()) {
            ...
            onRecordedFail(cn.shu.heartsound.recorder.IdealConst.RecorderErrorCode.RECORDER_PERMISSION_ERROR);
        }
    ...
    public void onRecordedFail(final int paramInt) {
        ...
        runOnUi(new Runnable() {
            public void run() {
                String errorMsg = "";
                switch (paramInt) {
                    case cn.shu.heartsound.recorder.IdealConst.RecorderErrorCode.RECORDER_EXCEPTION_OCCUR:
                        errorMsg = "启动或录音时抛出异常Exception";
                        break;
                    case cn.shu.heartsound.recorder.IdealConst.RecorderErrorCode.RECORDER_READ_ERROR:
                        errorMsg = "Recorder.read() 过程中发生错误";
                        break;
                    case cn.shu.heartsound.recorder.IdealConst.RecorderErrorCode.RECORDER_PERMISSION_ERROR:
